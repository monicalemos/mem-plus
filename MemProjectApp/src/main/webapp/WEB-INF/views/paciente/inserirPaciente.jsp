...
<div class="container">
	<div class="row-fluid" id="LoginForm">
		<form:form method="post" modelAttribute="pacienteModel"
			...
			<form:input path="dataNascimento" id="dataNascimento" class="form-control" required="required"
			...
			<form:input path="profissao" id="profissao"
				class="form-control" required="required" placeholder="Profissão" />
			
			<br>	
			<form:label path="escolaridade">Escolaridade:</form:label>
			<form:select path="escolaridade"  placeholder="Escolaridade" class="form-control">
		...
		<%-- 	<br>
			...
			<form:input path="nomeMedico" id="nomeMedico"
				class="form-control" required="required" placeholder="Nome do Médico" />
			<br>
