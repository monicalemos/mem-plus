...
<%
	...
	Evento evento = (Evento) request.getAttribute("eventoModel");
%>
...
<div id="page-wrapper">
	<div class="row-fluid" id="LoginForm">
		<form:form method="post" modelAttribute="eventoModel" action="editarEvento">
		
			<h2 class="form-signin-heading">Editar Dados do Evento</h2>
			...
			<br>
			<%
			pageContext.setAttribute("temFamiliarEscolhido", evento.getFamiliar());
			pageContext.setAttribute("listFamiliar", (listFamiliar.size() > 0 ? listFamiliar : null));
			%>
  			 <c:if test="${temFamiliarEscolhido != null}">
			...
			<c:if test="${temFamiliarEscolhido == null && listFamiliar != null}">
				<div class="checkbox">
						<input type="checkbox" value="1" id="temFamiliar" onclick="show('myGroup');"/>
						<label for="temFamiliar">Editar familiar presente</label>
