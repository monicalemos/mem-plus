...
<fieldset>
	...
	<div class="control-group">
		<label for="dateOfDeath" class="control-label">Data de Óbito:</label>
		<div class="controls">
		<span class="input-sm uneditable-input"><c:out value="${pacientModel.dateOfDeath}" /> 
		<form:hidden path="dateOfDeath" /></span>
		</div>
	</div>
	<div class="control-group">
		<label for="isCareGiver" class="control-label">É "Cuidador?":</label>
		<div class="controls">
		<form:checkbox   path="isCareGiver" cssClass="input-sm focused" id="isCareGiver"  disabled/> 
		<form:hidden path="isCareGiver" />
		</div>
	</div>
	<div class="control-group">
