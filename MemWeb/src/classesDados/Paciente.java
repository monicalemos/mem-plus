...
public class Paciente extends Pessoa implements Serializable {
    ...
    public Paciente(int idPessoa, String nome_completo,
            ...
            TipoGenero genero, String profissao, TipoEscolaridade escolaridade, TipoEstadoCivil estado_civil, String nivel_doenca, String nome_medico,
    ...
    private void setRelacoes() {
        System.out.println("set das relacões");
